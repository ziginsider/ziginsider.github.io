...
Конечно, это только одна сторона пользы от интерфейсов. Зато  очень наглядная на мой взгляд. Другая, очевидная поьза от интерфейсов - это придание гибкости коду в проекте (особенно в больших). См. e.g. принципы SOLID: <href="https://academy.realm.io/posts/donn-felker-solid-part-5/">https://academy.realm.io/posts/donn-felker-solid-part-5/</a>
