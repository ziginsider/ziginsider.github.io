...
Я не понял следующее высказываение о результатах запроса устанавливаемых внутрь окна:
...
Я постарабсь написать несколько простых тестов, чтобы проверить эту теорию и отчитаться.
