...
*Используются при сохранении состояния activity, при изменении конфигурации*
...
- onCreateLoader(int id, Bundle args) - необходимо вернуть нужный лоадер в зависимости от id, используя параметры из Bundle;
- onLoadFinished(Loader<D> loader, D data) - в параметре D мы получим результат работы лоадера;
